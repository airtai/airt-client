...
# %% auto 0
__all__ = ['TorF', 'export', 'ensure_is_instance', 'get_base_url', 'post_data', 'get_data', 'delete_data', 'add_ready_column',
           'generate_df', 'get_values_from_item', 'get_attributes_from_instances', 'dict_to_df',
